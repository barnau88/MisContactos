...
public class DetalleContacto extends AppCompatActivity {
    ...
    public void llamar(View v) {
        ...
        //las siguientes lineas menos la de "startActivity(new Intent(Intent.ACTION_CALL, Uri.parse("telf:" + telefono)));" se han introducido
        //cuando esa linea nos daba error porq le faltaba un permiso, y se lo hemos añadido
        ...
        startActivity(new Intent(Intent.ACTION_CALL, Uri.parse("telf:" + telefono)));
    }
